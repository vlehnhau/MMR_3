...
print("Äquivalenzrelation: " + str(relationship.checkEquivalenceRelation(s.Set(["Alice", "Bob", "Charles", "Denise", "Eric"]))))

print("Ordnungen. SmallerEqual")
ordersSmallerEqual = s.Orders("smallerEqual")
print(ordersSmallerEqual)
print("Äquivalenzrelation: " + str(ordersSmallerEqual.checkEquivalenceRelation(s.Set(list(range(0,101))))))

print("Ordnungen. Smaller")
ordersSmaller = s.Orders("smaller")
print(ordersSmaller)
print("Äquivalenzrelation: " + str(ordersSmaller.checkEquivalenceRelation(s.Set(list(range(0,101))))))

print("Ordnungen. Equal")
ordersEqual = s.Orders("equal")
print(ordersEqual)
print("Äquivalenzrelation: " + str(ordersEqual.checkEquivalenceRelation(s.Set(list(range(0,101))))))

print("Restklassen")
rest5 = s.Remainder(5)
print(rest5)
print("Äquivalenzrelation: " + str(rest5.checkEquivalenceRelation(s.Set(list(range(0,51))))))

print("Äquvalenzklassen")
print(s.equivalenceClasses(s.Relation([(1,1),(1,2),(2,2),(2,1),(3,3),(3,4),(4,4),(4,3)]), s.Set([1,2,3,4])))
print("Equals Klassen: " + str(s.equivalenceClasses(ordersEqual, s.Set(list(range(0,101))))))
print("Restklassen Klassen: " + str(s.equivalenceClasses(rest5, s.Set(list(range(0,51))))))
